...
set EditorLocation="C:\SleepersHaunting\UnrealEngine-5.2\Engine\Binaries\Win64\UnrealEditor.exe"
set UProjectLocation="%~dp0UnrealEngine-5.2\SleepersHaunting\SleepersHaunting.uproject"
